...
CREATE TABLE `order_items` (
  ...
  `status` enum('CANCELLED','COMPLETED','DELIVERED','PAID','PAYMENT_EXPIRED','PAYMENT_FAILED','PENDING_CONFIRMATION','PENDING_PAYMENT','PROCESSING','SHIPPING') NOT NULL,
...
CREATE TABLE `orders` (
  ...
  `status` enum('CANCELLED','COMPLETED','DELIVERED','PAID','PAYMENT_EXPIRED','PAYMENT_FAILED','PENDING_CONFIRMATION','PENDING_PAYMENT','PROCESSING','SHIPPING', 'CONFIRMED',
    'RETURNED') NOT NULL,
...
MODIFY COLUMN status ENUM(
    'CANCELLED', 'COMPLETED', 'DELIVERED', 'PAID', 
    'PAYMENT_EXPIRED', 'PAYMENT_FAILED', 'PENDING_CONFIRMATION', 
    'PENDING_PAYMENT', 'PROCESSING', 'SHIPPING', 'CONFIRMED', 'RETURNED'
);
